...
namespace G2Cy.WpfHost
{
    internal class PluginController : IDisposable
    {
        ...
        public PluginController(IContainerExtension container, ErrorHandlingService errorHandlingService)
        {
        ...
        public string[] GetUnsavedItems(Plugin plugin)
        {
            try
            {
                var service = (IUnsavedData)(plugin.GetService(typeof(IUnsavedData)));
